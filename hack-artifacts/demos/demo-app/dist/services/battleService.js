...
const fighterService_1 = require("./fighterService");
/**
...
class BattleService {
     ...
     */
    narrate(attacker, defender, damage) {
        const actions = [
     ...
     */
    simulateBattle(fighter1Id, fighter2Id) {
        const fighter1 = fighterService_1.fighterService.getFighterById(fighter1Id);
        const fighter2 = fighterService_1.fighterService.getFighterById(fighter2Id);
        ...
        if (winner === fighter1.id) {
            fighterService_1.fighterService.updateFighter(fighter1.id, { wins: fighter1.wins + 1 });
            fighterService_1.fighterService.updateFighter(fighter2.id, { losses: fighter2.losses + 1 });
        }
        else {
            fighterService_1.fighterService.updateFighter(fighter2.id, { wins: fighter2.wins + 1 });
            fighterService_1.fighterService.updateFighter(fighter1.id, { losses: fighter1.losses + 1 });
        }
        const result = {
            id: (0, uuid_1.v4)(),
...
exports.battleService = new BattleService();
